...
3. For one-topic-per-request behavior, enable Topics in the main supergroup, give Jeff topic-management administrator permission, and set that chat ID as `TELEGRAM_FORUM_CHAT_ID`.
